...
/**
 * Ce test ouvre journeys avec le formulaire et fait une recherche d'itinéraire en commençant de saisir le départ
 * 
 * @author mamrani
 *
 */
public class B_DoSimpleItinerarySearch_DepartureArrival extends A_AbstractJourneysTest {                               
	...
	/**
	 * Saisie du champs arrivée après avoir saisi le départ
	 * 
	 * @throws Exception
	 */
