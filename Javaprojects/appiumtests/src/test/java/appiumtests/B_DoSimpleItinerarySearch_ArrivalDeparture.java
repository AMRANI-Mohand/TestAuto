...
/**
 * Ce test ouvre journeys avec le formulaire et fait une recherche d'itinéraire en commençant de saisir l'arrivée
 * 
 * @author mamrani
 *
 */
public class B_DoSimpleItinerarySearch_ArrivalDeparture extends B_DoSimpleItinerarySearch_DepartureArrival {
	...
	/**
	 * Ouverture de l'auto-completion et saisie du champs arrivée
	 * 
	 * @throws Exception
	 */
