...
public class Z_SaveTests2 {
	...
	static void Fill_in_the_departure_field() throws Exception {
		...
		driver.findElement(MobileBy.xpath("//android.view.ViewGroup[@content-desc=\"Arrêt Gare de Lyon (Paris)\"]"))
				.click();
	}
	...
	static void Fill_in_the_arrival_field() throws Exception {
		...
		driver.findElement(MobileBy.xpath("//android.view.ViewGroup[@content-desc=\"Arrêt République (Paris)\"]"))
				.click();
	}
...
/*
	static void find_transport_mode() throws Exception {
		...
		driver.findElement(MobileBy.id("org.kisio.sample.navitia.sdk.ui:id/vps_recycler"))
				.findElement(MobileBy.xpath("//android.widget.ImageView[@content-desc=\"Vélo\"]"));
		driver.findElement(MobileBy.id("org.kisio.sample.navitia.sdk.ui:id/vps_recycler"))
				.findElement(MobileBy.xpath("//android.widget.ImageView[@content-desc=\"Vélo en libre service\"]"));
		driver.findElement(MobileBy.id("org.kisio.sample.navitia.sdk.ui:id/vps_recycler"))
	...
	static void componenets_selected_by_default() throws Exception {
		...
		if (driver.findElement(MobileBy.id("org.kisio.sample.navitia.sdk.ui:id/vps_recycler"))
				...
				&& driver.findElement(MobileBy.id("org.kisio.sample.navitia.sdk.ui:id/vps_recycler"))
						.findElement(MobileBy.xpath("//android.widget.ImageView[@content-desc=\"Vélo\"]")).isSelected()

				&& driver.findElement(MobileBy.id("org.kisio.sample.navitia.sdk.ui:id/vps_recycler"))
						.findElement(
								MobileBy.xpath("//android.widget.ImageView[@content-desc=\"Vélo en libre service\"]"))
						.isSelected()
	...
	static void click_on_transport_mode() throws Exception {
		...
		driver.findElement(MobileBy.id("org.kisio.sample.navitia.sdk.ui:id/vps_recycler"))
				.findElement(MobileBy.xpath("//android.widget.ImageView[@content-desc=\"Vélo\"]")).click();
